#
# Modified from manimlib.config by Starsky
# main purpose/difference:
#  - manimhub.config doesn't do the import job
#  - some corner config that I don't use personally are removed for clearity
#
import argparse
import colour
...
def get_configuration(args):
	...
	# The module is no longer imported here. Set None here for compatability sake.
	module = None 
